...
{
    public partial class Product_B : UserControl
    {
        public readonly string Product_Style_B_Html = Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory + "Html\\Template\\ProductStyle\\product_sylte_b.html");
        ...
        public string Get_Pending_Join_Html_Content()
        {
            ...
            try
            {
                using (StreamReader sr = new StreamReader(Product_Style_B_Html))
                {
